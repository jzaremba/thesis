...
\begin{figure}
	...
	\caption{Breakdown of non-communicable disease cost by disease type}
	\label{fig:intro:scz:output_loss}
\end{figure}

Since the underlying aetiology is still poorly understood, \scz/ is a syndrome defined by its symptoms, the most prominent of which is psychosis.
...
In agreement with the well-characterized hippocampal deficits in \scz/ patients (see \autoref{sec:intro:scz:hpc}), allocentric navigation is hippocampus-dependent (see \autoref{sec:intro:hpc:spatial}), while egocentric navigation primarily relies on the caudate nucleus \citep{Hartley2003}.
...
Additionally, postmortem studies have found decreased levels of pre-synaptic GABAergic machinery, including GAT, GAD67, and parvalbumin (PV), in both the prefrontal cortex (PFC) and HPC \citep{Coyle2006, Zhang2002, Konradi2011}.
