...
\todo[color=green]{Fix or replace website references.}
...
As we have learned more about the way neural circuits govern behavior in healthy individuals, the precise nature of cognitive deficits in patients, and the molecular changes that occur in \scz/, it is becoming clear the \scz/ is at it's core a neurodevelopmental dysfunction of neural circuits \citep{Arguello2012}\citep{Insel2010a}\citep{Insel2010b}\citep{Lewis2002}.
...
While there are well-characterized defciits in \scz/ patients in multiple brain regions, including primarily the \ac{PFC} \citep{XXX} and striatum \citep{XXX}, my main research has been on hippocampal-dependent episodic memory impairment, so I will focus particularly on the \ac{HPC} in the following sections.
...
These large gene chip and whole genome sequencing studies have found strong evidence for a role of \emph{de novo} \ac{CNVs} as well as \ac{SNVs} in sporadic cases of \scz/ \citep{Xu2008}\citep{Xu2011}.
...
Individuals with 22q11.2 deletions exhibit a spectrum of cognitive deficits as children, and $\approx$30\% of them develop \scz/ in adolescence or early adulthood, accounting for up to 2\% of all \scz/ cases \citep{Karayiorgou2010}.
Deletions including genes within the region are among the most common deletions in humans \citep{XXXX}.
\todo[color=green]{Expand on 22q11.2}

\subsubsection{Individual genes within 22q11.2 locus}
Mouse model haploinsufficient for DiGeorge critical region 8 (\emph{Dgcr8}), a microRNA processing gene affected by 22q11.2 deletion, shows similar working memory deficits as mouse model with entire 22q11.2 deletion \citep{Stark2008}.
...
miR-185 \citep{Xu2013a} \\
Zdhhc8 \citep{Mukai2015}\citep{Mukai2008} \\
ProdH and Comt \citep{Paterlini2005} \\
Comt \citep{Kaenmaki2010}
\todo[color=yellow]{Finish this section.}
...
Decreased inhibition of CA1PCs and induction protocol-specific deficits in SC LTP \citep{Drew2011b}).
\todo[inline, color=green]{Improve flow and expand on this sentence.}
...
\todo[inline, color=yellow]{SCZ as neurodevelopmental disorder}
The typical age for a first psychotic episode is 18-25 years, though there is 
Evidence for pre-diagnoses symptoms from birth cohort studies: "behavioral disturbances and psychopathology, intellectual and language deficits, and early motor delays. Evidence with respect to alterations in language, educational performance, and physical growth has also been identified in some studies." \citep{Welham2009}
