...
\todo[color=cyan]{Recapitualtion of the main findings with 4-5 bulletpoints would be useful here.}
...
\todo[color=yellow]{finish LRIP for context in \df/}
...
\end{figure}
\todo[color=green]{Write better caption for chronic stability data.}
